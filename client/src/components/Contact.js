    ...
    const sendMessage = async (e) => {
        try {
            ...
            const result = await fetch(("/messageConsumer"), {
                ...
                body: JSON.stringify({
                    acno,email,message,password,type:"user"
                })
            })
    ...
    return (
        <>
            <div id="contact" className={style.container+ " col-10 mx-auto my-5"}>
                <h3 className="mx-auto p-2 col-6 ">Contact Us</h3>
                ...
                <div className="mb-3 col-10 col-md-auto col-lg-3 p-0 d-flex mx-auto">
                    ...
                    <Button className={style.sendMsg + " col-10 col-sm-6 col-md-4 mx-auto my-3"} onClick={sendMessage}>Submit Messsage</Button>
                </form>
            </div>
